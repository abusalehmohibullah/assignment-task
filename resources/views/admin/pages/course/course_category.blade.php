        ...
        <div class="col-lg-12">
            <div class="shop-breadcrumb">
                ...
                <div class="breadcrumb-main">
                    <h4 class="text-capitalize breadcrumb-title">Project Category</h4>

                    <div class="flex-wrap breadcrumb-action justify-content-center">
                        <button onclick="editModal(`{{ route('categories.create', ['language' => app()->getLocale()]) }}`,'category-form-modal','form-modal','Add Category')" class="btn btn-sm btn-primary me-0 radius-md">
                            <i class="la la-plus"></i> Add Project Category
                        </button>
                        ...
                        <div class="mt-10 project-search order-search global-shadow d-flex align-items-center gap-5">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select onchange="location = this.value;" class="form-select" aria-label="Default select example">
                                    <option value="?" {{ $is_featured == null && $status == null ? 'selected' : '' }}>All
                                    </option>
                                ...
                                <tbody>
                                    ...
                                    <tr id="category-{{ $category->id }}">
                                        ...
                                        <td role="button">
                                            <div class="orderDatatable-status d-inline-block">
                                                <div class="dm-switch-wrap">
                                                    <div onclick="updateStatus(`{{ route('categories.status', ['category' => $category->id]) }}`, 'Are you sure?', 'Dou you want to change the status of this category?', 'Yes', 'No', event )" class="form-check form-switch form-switch-primary form-switch-sm">
                                                        <input type="checkbox" class="form-check-input" id="status-switch-{{ $category->id }}" {{ $category->status === 'approved' ? 'checked' : '' }}>
                                        ...
                                        <td>
                                            <ul class="mb-0 orderDatatable_actions d-flex float-end">
                                                ...
                                                <li>
                                                    <a onclick="editModal(`{{ route('categories.edit', ['category' => $category->id], ['language' => app()->getLocale()]) }}`,'category-form-modal','form-modal')" class="edit">
                                                ...
                                                <li>
                                                    <a onclick="deleteData(`{{ route('categories.destroy', ['category' => $category->id]) }}`, `#category-{{ $category->id }}`)" class="remove" title="Remove Category">
                                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
