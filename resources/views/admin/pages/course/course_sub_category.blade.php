            ...
            <div class="shop-breadcrumb">
                ...
                <div class="breadcrumb-main">
                    ...
                    <div class="flex-wrap breadcrumb-action justify-content-center">
                        <button onclick="editModal(`{{ route('subcategories.create', ['language' => app()->getLocale()]) }}`,'category-form-modal','form-modal','Add Sub Category')" class="btn btn-sm btn-primary me-0 radius-md">
                            <i class="la la-plus"></i> Add Sub Category
                        </button>
...
<div class="container-fluid">
                    ...
                    <div class="flex-wrap d-flex align-items-center justify-content-center">
                        <div class="mt-10 project-search order-search global-shadow d-flex align-items-center gap-5">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <p>Status:</p>
                                <select onchange="location = this.value;" class="form-select" aria-label="Default select example">
                                    <option value="?" {{ $status == null ? 'selected' : '' }}>All
                                    </option>
                                    <option value="?status=pending" {{ $status !== null && $status == 'pending' ? 'selected' : '' }}>
                                        Pending</option>
                                    <option value="?status=approved" {{ $status !== null && $status == 'approved' ? 'selected' : '' }}>
                                        Approved</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="content-center mt-10 d-flex align-items-center gap-4">
                        <form id="sort_courses" action="" method="GET">
                            ...
                            <div class="order-search__form">
                                ...
                                <input value="{{ $search_text }}" name="search_text" class="border-0 form-control me-sm-2 box-shadow-none" type="search" placeholder="Search" aria-label="Search" value="{{ $search_text }}">
                                        ...
                                        <td role="button">
                                            <div class="orderDatatable-status d-inline-block">
                                                <div class="dm-switch-wrap">
                                                    <div onclick="updateStatus(`{{ route('subcategories.status', ['subcategory' => $subcategory->id]) }}`, 'Are you sure?', 'Dou you want to change the status of this sub-category?', 'Yes', 'No', event )" class="form-check form-switch form-switch-primary form-switch-sm">
                                                        <input type="checkbox" class="form-check-input" id="status-switch-{{ $subcategory->id }}" {{ $subcategory->status === 'approved' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="status-switch-{{ $subcategory->id }}"></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
    ...
    <!--Add Sub Category-->
    <div class="modal fade new-member " id="category-form-modal" role="dialog" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
